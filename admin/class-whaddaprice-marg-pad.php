...
class Whadda_marg_pad {
  ...
  public function whadda_marg_pad() {
    ...
    echo '<p>'.esc_html__('margin-top ( em )','whaddaprice').'</p><input type="number" name="' . $margin_top_r . '" id="' . $margin_top_r . '" step="0.1" min="0" value="' . $mtop_r . '">';
    echo '<p>'.esc_html__('margin-right ( em )','whaddaprice').'</p><input type="number" name="' . $margin_right_r . '" id="' . $margin_right_r . '" step="0.1" min="0" value="' . $mright_r . '">';
    echo '<p>'.esc_html__('margin-bottom ( em )','whaddaprice').'</p><input type="number" name="' . $margin_bottom_r . '" id="' . $margin_bottom_r . '" step="0.1" min="0" value="' . $mbottom_r . '">';
    echo '<p>'.esc_html__('margin-left ( em )','whaddaprice').'</p><input type="number" name="' . $margin_left_r . '" id="' . $margin_left_r . '" step="0.1" min="0" value="' . $mleft_r . '">';
    echo '</div>';
    echo '<div class="mprighempcol">';
    echo '<p>'.esc_html__('padding-top ( em )','whaddaprice').'</p><input type="number" name="' . $padding_top_r . '" id="' . $padding_top_r . '" step="0.1" min="0" value="' . $ptop_r . '">';
    echo '<p>'.esc_html__('padding-right ( em )','whaddaprice').'</p><input type="number" name="' . $padding_right_r . '" id="' . $padding_right_r . '" step="0.1" min="0" value="' . $pright_r . '">';
    echo '<p>'.esc_html__('padding-bottom ( em )','whaddaprice').'</p><input type="number" name="' . $padding_bottom_r . '" id="' . $padding_bottom_r . '" step="0.1" min="0" value="' . $pbottom_r . '">';
    echo '<p>'.esc_html__('padding-left ( em )','whaddaprice').'</p><input type="number" name="' . $padding_left_r . '" id="' . $padding_left_r . '" step="0.1" min="0" value="' . $pleft_r . '">';
    echo '</div></div>';
    echo '<div class="clear"></div>';
    echo '<div>';
    echo '<h3>'.esc_html__('Margin e Padding -COLONNE-','whaddaprice').'</h3>';
    echo '<div class="mprighempcol">';
    echo '<p>'.esc_html__('margin-top ( em )','whaddaprice').'</p><input type="number" name="' . $margin_top_c . '" id="' . $margin_top_c . '" step="0.1" min="0" value="' . $mtop_c . '">';
    echo '<p>'.esc_html__('margin-right ( em )','whaddaprice').'</p><input type="number" name="' . $margin_right_c . '" id="' . $margin_right_c . '" step="0.1" min="0" value="' . $mright_c . '">';
    echo '<p>'.esc_html__('margin-bottom ( em )','whaddaprice').'</p><input type="number" name="' . $margin_bottom_c . '" id="' . $margin_bottom_c . '" step="0.1" min="0" value="' . $mbottom_c . '">';
    echo '<p>'.esc_html__('padding-left ( em )','whaddaprice').'</p><input type="number" name="' . $margin_left_c . '" id="' . $margin_left_c . '" step="0.1" min="0" value="' . $mleft_c . '">';
    echo '</div>';
    echo '<div class="mprighempcol">';
    echo '<p>'.esc_html__('padding-top ( em )','whaddaprice').'</p><input type="number" name="' . $padding_top_c . '" id="' . $padding_top_c . '" step="0.1" min="0" value="' . $ptop_c . '">';
    echo '<p>'.esc_html__('margin-right ( em )','whaddaprice').'</p><input type="number" name="' . $padding_right_c . '" id="' . $padding_right_c . '" step="0.1" min="0" value="' . $pright_c . '">';
    echo '<p>'.esc_html__('margin-bottom ( em )','whaddaprice').'</p><input type="number" name="' . $padding_bottom_c . '" id="' . $padding_bottom_c . '" step="0.1" min="0" value="' . $pbottom_c . '">';
    echo '<p>'.esc_html__('padding-left ( em )','whaddaprice').'</p><input type="number" name="' . $padding_left_c . '" id="' . $padding_left_c . '" step="0.1" min="0" value="' . $pleft_c . '">';
    echo '</div></div>';
    echo '<div class="clear"></div>';
  }
